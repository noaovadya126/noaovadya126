...
class KoreanWordProcessor:
    def __init__(self, root):
        self.root = root
        self.root.title("Korean Word Processor - Test Mode")
    ...
    def setup_ui(self):
        title_label = tk.Label(self.root, text="Korean Word Processor - Test Mode", font=("Arial", 16, "bold"), bg='#f0f0f0')
    ...
    def test_first_50(self):
        ...
        try:
            ...
            for index in range(test_rows):
                ...
                preview_data.append(f"{index+1:2d}. {korean_word:12s} ({pos:6s}) | Original: {original_guide:25s} | AI: {ai_output}")
